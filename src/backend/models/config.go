...
const (
	...
	// e.g  https://github.com/{{app.name}}, if the app name is basa, will redirect to https://github.com/kubeservice-stack/Opscenter
	ConfigKeyMonitorUri ConfigKey = "system.monitor-uri"
	// Option Values : join none
	// join: means ApiName will join with app name e.g. app name is basa, deployment name is foo, the final name is basa-foo
