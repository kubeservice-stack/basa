...
import (
	...
	"github.com/kubeservice-stack/basa/src/backend/resources/proxy"
...
// @Param	filter		query 	string	false		"the labelSelector for list e.g. filter=app=infra-basa,basa-app=infra"
