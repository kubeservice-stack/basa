...
import (
	...
	"github.com/kubeservice-stack/basa/src/backend/controllers/apikey"
	"github.com/kubeservice-stack/basa/src/backend/controllers/app"
	"github.com/kubeservice-stack/basa/src/backend/controllers/appstarred"
	"github.com/kubeservice-stack/basa/src/backend/controllers/auditlog"
	"github.com/kubeservice-stack/basa/src/backend/controllers/auth"
	"github.com/kubeservice-stack/basa/src/backend/controllers/bill"
	"github.com/kubeservice-stack/basa/src/backend/controllers/cluster"
	"github.com/kubeservice-stack/basa/src/backend/controllers/config"
	"github.com/kubeservice-stack/basa/src/backend/controllers/configmap"
	"github.com/kubeservice-stack/basa/src/backend/controllers/cronjob"
	"github.com/kubeservice-stack/basa/src/backend/controllers/customlink"
	"github.com/kubeservice-stack/basa/src/backend/controllers/daemonset"
	"github.com/kubeservice-stack/basa/src/backend/controllers/deployment"
	"github.com/kubeservice-stack/basa/src/backend/controllers/hpa"
	"github.com/kubeservice-stack/basa/src/backend/controllers/ingress"
	kconfigmap "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/configmap"
	kcrd "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/crd"
	kcronjob "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/cronjob"
	kdaemonset "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/daemonset"
	kdeployment "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/deployment"
	kevent "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/event"
	khpa "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/hpa"
	kingress "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/ingress"
	kjob "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/job"
	klog "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/log"
	knamespace "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/namespace"
	knode "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/node"
	kpod "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pod"
	"github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/proxy"
	kpv "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pv"
	kpvc "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pvc"
	ksecret "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/secret"
	kservice "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/service"
	kstatefulset "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/statefulset"
	"github.com/kubeservice-stack/basa/src/backend/controllers/namespace"
	"github.com/kubeservice-stack/basa/src/backend/controllers/notification"
	"github.com/kubeservice-stack/basa/src/backend/controllers/openapi"
	"github.com/kubeservice-stack/basa/src/backend/controllers/permission"
	"github.com/kubeservice-stack/basa/src/backend/controllers/publish"
	"github.com/kubeservice-stack/basa/src/backend/controllers/publishstatus"
	"github.com/kubeservice-stack/basa/src/backend/controllers/pvc"
	"github.com/kubeservice-stack/basa/src/backend/controllers/secret"
	"github.com/kubeservice-stack/basa/src/backend/controllers/statefulset"
	"github.com/kubeservice-stack/basa/src/backend/controllers/webhook"
	"github.com/kubeservice-stack/basa/src/backend/health"
	_ "github.com/kubeservice-stack/basa/src/backend/plugins"
	"github.com/kubeservice-stack/basa/src/backend/util/hack"
)
