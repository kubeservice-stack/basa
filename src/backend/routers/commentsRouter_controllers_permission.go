...
func init() {
    const AppUserController = "github.com/kubeservice-stack/basa/src/backend/controllers/permission:AppUserController"
    ...
    const GroupController = "github.com/kubeservice-stack/basa/src/backend/controllers/permission:GroupController"
    ...
    const NamespaceUserController = "github.com/kubeservice-stack/basa/src/backend/controllers/permission:NamespaceUserController"
    ...
    const PermissionController = "github.com/kubeservice-stack/basa/src/backend/controllers/permission:PermissionController"
    ...
    const UserController = "github.com/kubeservice-stack/basa/src/backend/controllers/permission:UserController"
