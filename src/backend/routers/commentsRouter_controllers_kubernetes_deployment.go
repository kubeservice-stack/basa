...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/deployment:KubeDeploymentController"] = append(beego.GlobalControllerRouter["github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/deployment:KubeDeploymentController"],
