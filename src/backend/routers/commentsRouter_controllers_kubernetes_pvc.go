...
func init() {
    const KubePersistentVolumeClaimController = "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pvc:KubePersistentVolumeClaimController"
    ...
    const RobinPersistentVolumeClaimController = "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pvc:RobinPersistentVolumeClaimController"
