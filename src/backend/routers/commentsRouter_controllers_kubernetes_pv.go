...
func init() {
    const KubePersistentVolumeController = "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pv:KubePersistentVolumeController"
    ...
    const RobinPersistentVolumeController = "github.com/kubeservice-stack/basa/src/backend/controllers/kubernetes/pv:RobinPersistentVolumeController"
